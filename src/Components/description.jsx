  ...
  return (
    <div className="min-h-screen bg-transparent flex flex-col items-center justify-center font-script">
      <div className="relative w-full max-w-xl text-[#b40129] shadow-md rounded-lg p-8 overflow-hidden text-center">
        ...
        <p
  className="text-roseGold font-light leading-relaxed text-center px-4 py-2 max-w-[600px] mx-auto tracking-wide"
  style={{ fontFamily: "'Playfair Display', serif", fontSize: "1rem", lineHeight: "1.75rem" }}
>
  ...
  tenemos el gusto de invitar a celebrar
        ...
        >
          ...
          <h3 className="font-bold text-[#ad4658] m-0 text-3xl">
            Iglesia Adventista Norte
          </h3>

          <p className="text-[#ca2037] text-3xl font-medium mb-2">
            Cra. 20 #6-47
          </p>
          <div className="flex items-center gap-2 mt-1 text-2xl font-medium">
            <span className="text-[#000000]">
              <span className="font-semibold text-[#e26868]">Hora: </span>6:00
              PM
            </span>
          </div>
          ...
          <a
            ...
            target="_blank"
            className="inline-flex items-center gap-2 text-white bg-[#ad4658] py-3 px-6 rounded-lg mt-3 transition-all duration-300 ease-in-out cursor-pointer border-2 border-[#ad4658] shadow-sm hover:bg-[#ad4658] hover:text-white"
            onMouseOver={(e) => {
