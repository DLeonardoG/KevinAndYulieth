...
const WeddingDetails = () => {
    ...
    useEffect(() => {
        const observer = new IntersectionObserver(
            ...
            },
            {
                root: null,
                rootMargin: '0px',
                threshold: 0.3, // cuando el 30% del sobre es visible
            }
        );
    ...
    return (
        <div className="min-h-screen bg-[#fd8684] py-12 mt-10 px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 md:gap-14 gap-8 md:px-20">
                <div className="bg-white rounded-lg shadow-lg p-6">
                    <div className="text-center mb-6">
                        ...
                        <img
                            ...
                            alt="Traje formal"
                            className="w-full h-auto mb-4 rounded-lg md:w-1/2 md:mx-auto"
                        />
                ...
                <div className="bg-white rounded-lg shadow-lg p-6">
                    <div className="text-center mb-6">
                        ...
                        <div
                            ref={envelopeRef}
                            className={`w-35 h-35 mx-auto transform transition-all duration-1000 ease-out ${isVisible
                                ? 'translate-x-0 opacity-100'
                                : '-translate-x-32 opacity-0'
                                }`}
                        >
                            <img src="/sobre.svg" alt="Sobre" className="w-28 h-28 mx-auto" />
                        </div>
                    ...
                    <div className="pt-4 border-t border-gray-100 flex flex-col justify-center items-center">
                        ...
                        <a
                            target="_blank"
                            href="https://photos.app.goo.gl/k4oaFbNhYcWuv1bW6"
            ...
            {/* CSS personalizado para títulos */}
            <style jsx>{`
                .wedding-title {
